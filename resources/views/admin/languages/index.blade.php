<x-layouts.admin :title="'Admin Languages - VJPrime'">
    ...
    <section class="mt-5 rounded-xl border border-white/10 bg-slate-900/70 p-4">
        <div class="mb-4 flex items-center justify-between">
            ...
            <a href="{{ route('admin.languages.create') }}" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white">Add Language</a>
        </div>
            ...
            @foreach ($languages as $language)
                <div class="flex items-center justify-between rounded-md border border-white/10 bg-slate-950/60 px-3 py-2">
                    <div>
                        ...
                        <p class="text-xs text-slate-400">{{ $language->code }}</p>
                    </div>
                    <div class="flex gap-2">
                        <a href="{{ route('admin.languages.edit', $language) }}" class="rounded-md border border-white/20 px-3 py-1 text-xs">Edit</a>
