...
<div class="grid gap-3 sm:grid-cols-2">
    ...
    <input type="url" name="poster_url" value="{{ old('poster_url', $movie->poster_url ?? '') }}" placeholder="Poster URL" class="rounded-md border border-white/10 bg-slate-950 px-3 py-2 text-sm">
    <input type="url" name="backdrop_url" value="{{ old('backdrop_url', $movie->backdrop_url ?? '') }}" placeholder="Backdrop URL" class="rounded-md border border-white/10 bg-slate-950 px-3 py-2 text-sm">
